...
# Função para adicionar um novo contato na agenda, verificando duplicatas
def novo():
    global agenda, alterada
    nome = pede_nome()
    endereco = pede_endereco()

    # Verifica se já existe um contato com o mesmo nome e endereço
    for contato in agenda:
        if contato[0] == nome and contato[2] == endereco:
            print("Erro: Contato com o mesmo nome e endereço já existe na agenda.")
            return
